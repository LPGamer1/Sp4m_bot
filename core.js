...
// ✅ TRAVA ZAP 3 (Gerado via código para não dar erro de tamanho)
// Este padrão repete o texto "100%..." e barras até encher o limite de caracteres
...
module.exports = async (TOKEN, CLIENT_ID) => {
    ...
    client.on('interactionCreate', async interaction => {
        ...
        if (commandName === 'trava_zap2') {
            // Envia o texto caótico 10 vezes
            for(let i=0; i < 10; i++) {
                if (stopSignals.get(user.id)) break;
                // .substring garante que não passa de 1950 chars e trava o bot
        ...
        if (commandName === 'trava_zap3') {
            // Envia o texto de carregamento 10 vezes
            for(let i=0; i < 10; i++) {
                if (stopSignals.get(user.id)) break;
